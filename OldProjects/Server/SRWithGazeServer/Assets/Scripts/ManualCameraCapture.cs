...
namespace FFmpegOut
{
    ...
    public class ManualCameraCapture : MonoBehaviour
    {
        ...
        public void StartCapturing (string fileName)
        {
            if (_pipe == null) OpenPipe (fileName);
        }
